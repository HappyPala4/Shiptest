GLOBAL_LIST_INIT(donations_list, list(
	...
	"Hats" = list(
		...
		new /datum/donate_info("Witch Hat",					/obj/item/clothing/head/wizard/marisa,						300),
	...
	"Jumpsuits" = list(
		...
		new /datum/donate_info("Bouncer Uniform",		/obj/item/clothing/under/misc/bouncer,			150),
	...
	"Cloaks" = list(
		...
		new /datum/donate_info("CMO Cloak",			/obj/item/clothing/neck/cloak/cmo,							250),
		new /datum/donate_info("QM Cloak",			/obj/item/clothing/neck/cloak/qm,							250),
		new /datum/donate_info("HOS cloak",			/obj/item/clothing/neck/cloak/hos,							250),
		new /datum/donate_info("RD cloak",			/obj/item/clothing/neck/cloak/rd,							250),
		new /datum/donate_info("CE cloak",			/obj/item/clothing/neck/cloak/ce,							250),
	...
	"Special Stuff" = list(
		...
		new /datum/donate_info("Space Cash",				/obj/item/stack/spacecash/c1000,					600),
